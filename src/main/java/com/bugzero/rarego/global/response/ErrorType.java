...
public enum ErrorType {
	...
	AUCTION_ORDER_ACCESS_DENIED(401, 2008, "낙찰 기록 정보에 접근 권한이 없습니다."),
	AUCTION_SELLER_MISMATCH(403, 2009, "해당 경매의 판매자가 아닙니다."),
	AUCTION_NOT_ENDED(400, 2010, "종료된 경매만 재등록할 수 있습니다."),
	AUCTION_ALREADY_SOLD(409, 2011, "이미 판매가 완료되거나 진행 중인 상품입니다."),
